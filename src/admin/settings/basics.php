...
<div class="wrap">
    <h2>
        <img src="<?php echo plugin_dir_url(__FILE__) . "../../../assets/images/logo.png" ?>" style="width: 30px; vertical-align:middle; margin: 0px 5px;">
        ...
        <?php foreach($field_sets as $field_set) { ?>
            <?php foreach($field_set as $key => $field) { ?>
                ...
                <div style="<?php echo($style) ?>" id="<?php echo($key) ?>">
                    <div style="display:inline-block; width:100px; padding:5px 15px; vertical-align: top;"><?php echo($field["title"]) ?></div>
                    <div style="display:inline-block; padding:2px 15px;">
                        ...
                        <?php } elseif ($type == 'textarea') {  ?>
                            <textarea style="width:700px; height: 200px;" name="<?php echo($key) ?>" placeholder="<?php echo($field["default"]) ?>"><?php echo(stripcslashes($field["value"])) ?></textarea>
